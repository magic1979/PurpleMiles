				...
				if(item.Token==1){
				  ...
				  if(item.importo==0){
				   ...
				   if(item.posticipata==0){
				     tempistica = "<table><tr><td><b><div>"+localStorage.getItem("sessionTempo")+" </div></b></td><td><b> " + item.tempo + " </b></td><td><div id='h4minuti'>minuti</div></td></tr></table>";
				   }
				   else{
